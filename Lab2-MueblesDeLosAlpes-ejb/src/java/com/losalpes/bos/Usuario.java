...
public class Usuario
{
    ...
    private ArrayList<Mueble> comprasPendientes;
    ...
    /**
     * @return the comprasPendientes
     */
    public ArrayList<Mueble> getComprasPendientes() {
        return comprasPendientes;
    }

    /**
     * @param comprasPendientes the comprasPendientes to set
     */
    public void setComprasPendientes(ArrayList<Mueble> comprasPendientes) {
